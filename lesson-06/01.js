...
const img = document.getElementById("web-tech-image");   // находим элемент по id
const prevBtn = document.getElementById("prev-button");   // находим элемент по id
const nextBtn = document.getElementById("next-button");   // находим элемент по id

prevBtn.addEventListener("click", function(){
  index = index - 1;  // уменьшаем индекс на 1
  if(index < 0){
